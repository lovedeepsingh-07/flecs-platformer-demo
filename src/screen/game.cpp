...
void Screen::GameScreen::on_enter(flecs::world& registry) {
    ...
    // m_world_def.gravity.y = 9.8F * Constants::WORLD_SCALE *
    // Constants::FORCE_CONST; m_world_id = b2CreateWorld(&m_world_def);
...
void Screen::GameScreen::on_update(flecs::world& registry) {
    // b2World_Step(m_world_id, Constants::TIME_STEP,
    // Constants::SUB_STEP_COUNT); ControllerSystem::update(registry);
